...
output <- read.delim("C:/Projekte/TTC 2015/Train Benchmark Case/trainbenchmark-ttc-master/output/output.tsv")

results <- subset(subset(output, ChangeSet=="proportional"), MetricName == "memory", select=c(RunIndex, Tool, Size, Query, Iteration, MetricValue))
